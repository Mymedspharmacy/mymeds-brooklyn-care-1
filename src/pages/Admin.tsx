              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-1 sm:space-x-2 lg:space-x-4">
                  ...
                  <Button 
                    ...
                    className="p-2 sm:px-3 text-red-600 border-red-200 hover:bg-red-50"
                  >
                  ...
                  <TabsList className="flex w-full h-auto bg-transparent min-w-max">
                    {TABS.map((tabItem) => (
                      <TabsTrigger
                        key={tabItem.id}
                        value={tabItem.id}
                        className="flex items-center space-x-1 sm:space-x-2 px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-md data-[state=active]:bg-[#376F6B] data-[state=active]:text-white whitespace-nowrap flex-shrink-0"
                      >
