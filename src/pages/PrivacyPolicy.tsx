          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 space-y-8">
            ...
            <section>
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-[#376f6b]">Information Sharing</h2>
              </div>
              <div className="space-y-4 text-gray-700">
                <p>We do not sell, trade, or rent your personal information to third parties. We may share your information in the following circumstances:</p>
                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li><strong>Healthcare Providers:</strong> With your consent, we may share information with your doctors and healthcare providers</li>
            ...
            <section className="bg-gray-50 rounded-xl p-6">
              ...
              <div className="space-y-2 text-gray-700">
                ...
                <p>Email: info@mymedspharmacy.com</p>
                <p className="mt-4">
