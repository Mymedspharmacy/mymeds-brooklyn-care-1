      ...
      <header className="bg-white shadow-lg sticky top-0 z-50 border-b-2 border-[#57bbb6]">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between gap-6">
          ...
          <div className="lg:hidden">
            <button
              className="flex items-center justify-center p-2 rounded-md text-[#57bbb6] hover:bg-[#f5fefd] focus:outline-none focus:ring-2 focus:ring-[#57bbb6]"
          ...
          <div onClick={() => navigate('/')} className="flex-shrink-0 cursor-pointer">
            <img
              ...
              className="h-16 w-auto sm:h-20 md:h-24 object-contain transition-all duration-300 ease-in-out"
            />
          </div>
