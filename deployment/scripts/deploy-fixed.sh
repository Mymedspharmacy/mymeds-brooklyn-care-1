#!/bin/bash
# =============================================================================
# FIXED DEPLOYMENT SCRIPT - MyMeds Pharmacy Inc.
# =============================================================================
...
echo "🚀 MyMeds Pharmacy Inc. - Fixed Deployment for VPS"
echo "=================================================="
...
docker-compose -f "$DOCKER_COMPOSE_FILE" exec -T mymeds-app npx prisma migrate deploy

# Generate Prisma client
log_info "Generating Prisma client..."
docker-compose -f "$DOCKER_COMPOSE_FILE" exec -T mymeds-app npx prisma generate

# Initialize integrations
log_info "Initializing integrations..."
docker-compose -f "$DOCKER_COMPOSE_FILE" exec -T mymeds-app node init-integrations.js

# Create admin user
log_info "Creating admin user..."
docker-compose -f "$DOCKER_COMPOSE_FILE" exec -T mymeds-app node -e "
...
async function createAdmin() {
  try {
    const hashedPassword = await bcrypt.hash('Mymeds2025!AdminSecure123!@#', 12);
...
echo ""
log_success "🎉 MyMeds Fixed deployment completed successfully!"
echo ""
