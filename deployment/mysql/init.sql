-- =============================================================================
-- MYSQL INITIALIZATION SCRIPT - MyMeds Pharmacy Inc.
-- =============================================================================
-- Production database setup and initialization
-- =============================================================================
...
-- Log initialization
INSERT INTO mysql.general_log VALUES (NOW(), 'mymeds-init', 'MyMeds Pharmacy Inc. database initialized successfully');
